...
# We fix the couples:
V_people_couples = [0,0,1,1,2,2,3,3,4,4]

print(V_people_couples)
...
print(V_people_couples[1], V_people_couples[2])

F_C_couples_never_meet_outside_own_houses = [
    number_of_meetings(p1_no, p2_no) == 2 for p1_no in range(PPL) for p2_no in range(PPL) if V_people_couples[p1_no] == V_people_couples[p2_no]
]
...
#F8_couple_present_at_own_party +\
#F9_no_same_house_always +\
#F_C_couples_never_meet_outside_own_houses # Change this per question

#phi = F_C_couples_never_meet_outside_own_houses # Change this per question
